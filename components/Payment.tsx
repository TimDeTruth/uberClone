    ...
    const { error } = await initPaymentSheet({
      ...
      intentConfiguration: {
        ...
        confirmHandler: async (
          ...
          //getting paymentIntent from the backend @ /(api)/(stripe)/create+api.ts
          ...
          /* are we getting the client secret from the backend? if so, then we can actually make a payment based on the payment intent */
